                ...
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        ...
                        <div className="space-y-4 text-gray-300 leading-relaxed">
                            ...
                            <p>
                                Committed to learning, I earned an Associate's degree in Computer Science in 2020 while working full-time, and am now pursuing a Master's degree at Georgia Tech! 🐝
                            </p>
                            
                            <p>
                                Currently, I work as a Software Engineer at Whissle, Inc. where we are researching and building cutting edge speech recognition technology. I've contributed to full stack development, software testing, and our cloud based CI/CD pipelines.
                            </p>
                    ...
                    >
                        <div className="bg-gradient-to-br from-primary/20 to-accent/20 rounded-2xl p-8 backdrop-blur-sm">
                            <div className="space-y-4">
                                ...
                                <p className="text-gray-300">Java, Spring Boot, PostgreSQL, TypeScript,<br />Node.js, Python, Full Stack Development,<br />Software Testing, CI/CD Pipelines</p>
